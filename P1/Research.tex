...
\item SALT was developed at the Institut für Informatik, Technische Universität München. It is a domain-specific specification and assertion language designed for expressing temporal properties. Advantages for programmers is a higher level of abstraction which makes coding concise. Intuitive temporal specifications are more readable compared to raw LTL formulas while remaining fully translatable to standard temporal logics.
